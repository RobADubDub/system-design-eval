...
- **AI Assistant** - Ask questions about your notes and architecture and get structured insights, with quick actions for bottleneck analysis, security review, redundancy checks, and technology recommendations
...
2. **Take Notes** - Fill in the structured sections: functional reqs, workflows, non-functional reqs, entities, APIs, and deep dives
3. **Build Your Diagram** - Drag components from the palette onto the canvas and connect them
...
5. **Simulate Flows** - Test your architecture by simulating user scenarios step-by-step
6. **Benchmark** - Compare your design against a reference architecture for your chosen scale profile and review scored insights
